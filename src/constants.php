...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "crudperumdautama"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{9D218610-DFDB-45ED-A061-6301B9399DF0}"); // Project ID
