...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'lRuM8RNxYOXbgN8n', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/crudperumdautama.css", // Project stylesheet file name
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2023\\crudperumdautama\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2023\\crudperumdautama\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-9d218610-dfdb-45ed-a061-6301b9399df0", // Export folder
