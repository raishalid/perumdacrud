...
?>
<main class="view">
<form name="fpassword_reset_tokensview" id="fpassword_reset_tokensview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<?php if (!$Page->isExport()) { ?>
<script>
...
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fpassword_reset_tokensview")
        .setPageId("view")
        .build();
    window[form.id] = form;
    currentForm = form;
