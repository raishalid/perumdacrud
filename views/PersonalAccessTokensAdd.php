...
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fpersonal_access_tokensadd")
        .setPageId("add")
...
$Page->showMessage();
?>
<form name="fpersonal_access_tokensadd" id="fpersonal_access_tokensadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
loadjs.ready(["fpersonal_access_tokensadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpersonal_access_tokensadd", "x_last_used_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpersonal_access_tokensadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpersonal_access_tokensadd", "x_expires_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpersonal_access_tokensadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpersonal_access_tokensadd", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpersonal_access_tokensadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpersonal_access_tokensadd", "x_updated_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fpersonal_access_tokensadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fpersonal_access_tokensadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
