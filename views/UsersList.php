...
<?php if ($Page->email_verified_at->Visible) { // email_verified_at ?>
        <th data-name="email_verified_at" class="<?= $Page->email_verified_at->headerCellClass() ?>"><div id="elh_users_email_verified_at" class="users_email_verified_at"><?= $Page->renderFieldHeader($Page->email_verified_at) ?></div></th>
<?php } ?>
...
<?php if ($Page->remember_token->Visible) { // remember_token ?>
        <th data-name="remember_token" class="<?= $Page->remember_token->headerCellClass() ?>"><div id="elh_users_remember_token" class="users_remember_token"><?= $Page->renderFieldHeader($Page->remember_token) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_users_email_verified_at" class="el_users_email_verified_at">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_users_remember_token" class="el_users_remember_token">
