...
<?php if ($Page->id->Visible) { // id ?>
        <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div id="elh_customers_id" class="customers_id"><?= $Page->renderFieldHeader($Page->id) ?></div></th>
<?php } ?>
...
<?php if ($Page->slug->Visible) { // slug ?>
        <th data-name="slug" class="<?= $Page->slug->headerCellClass() ?>"><div id="elh_customers_slug" class="customers_slug"><?= $Page->renderFieldHeader($Page->slug) ?></div></th>
<?php } ?>
<?php if ($Page->photo->Visible) { // photo ?>
        <th data-name="photo" class="<?= $Page->photo->headerCellClass() ?>"><div id="elh_customers_photo" class="customers_photo"><?= $Page->renderFieldHeader($Page->photo) ?></div></th>
<?php } ?>
<?php if ($Page->product_id->Visible) { // product_id ?>
        <th data-name="product_id" class="<?= $Page->product_id->headerCellClass() ?>"><div id="elh_customers_product_id" class="customers_product_id"><?= $Page->renderFieldHeader($Page->product_id) ?></div></th>
<?php } ?>
<?php if ($Page->service_id->Visible) { // service_id ?>
        <th data-name="service_id" class="<?= $Page->service_id->headerCellClass() ?>"><div id="elh_customers_service_id" class="customers_service_id"><?= $Page->renderFieldHeader($Page->service_id) ?></div></th>
<?php } ?>
<?php if ($Page->created_at->Visible) { // created_at ?>
        <th data-name="created_at" class="<?= $Page->created_at->headerCellClass() ?>"><div id="elh_customers_created_at" class="customers_created_at"><?= $Page->renderFieldHeader($Page->created_at) ?></div></th>
<?php } ?>
<?php if ($Page->updated_at->Visible) { // updated_at ?>
        <th data-name="updated_at" class="<?= $Page->updated_at->headerCellClass() ?>"><div id="elh_customers_updated_at" class="customers_updated_at"><?= $Page->renderFieldHeader($Page->updated_at) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_customers_id" class="el_customers_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_customers_name" class="el_customers_name">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_customers_slug" class="el_customers_slug">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_customers_product_id" class="el_customers_product_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_customers_service_id" class="el_customers_service_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_customers_created_at" class="el_customers_created_at">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_customers_updated_at" class="el_customers_updated_at">
