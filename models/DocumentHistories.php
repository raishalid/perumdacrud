...
/**
 * Table class for document_histories
 */
class DocumentHistories extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "document_histories";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // notify
        $this->notify = new DbField(
            $this, // Table
            'x_notify', // Variable name
            'notify', // Name
            '`notify`', // Expression
            '`notify`', // Basic search expression
            16, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`notify`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->notify->InputTextType = "text";
        $this->notify->DataType = DATATYPE_BOOLEAN;
        $this->notify->Lookup = new Lookup('notify', 'document_histories', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
        $this->notify->OptionCount = 2;
        $this->notify->DefaultErrorMessage = $Language->phrase("IncorrectField");
        $this->notify->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['notify'] = &$this->notify;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "document_histories";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->notify->DbValue = $row['notify'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DocumentHistoriesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "DocumentHistoriesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "DocumentHistoriesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DocumentHistoriesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DocumentHistoriesView";
            case Config("API_ADD_ACTION"):
                return "DocumentHistoriesAdd";
            case Config("API_EDIT_ACTION"):
                return "DocumentHistoriesEdit";
            case Config("API_DELETE_ACTION"):
                return "DocumentHistoriesDelete";
            case Config("API_LIST_ACTION"):
                return "DocumentHistoriesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DocumentHistoriesView", $parm);
        } else {
            $url = $this->keyUrl("DocumentHistoriesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "DocumentHistoriesAdd?" . $parm;
        } else {
            $url = "DocumentHistoriesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentHistoriesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentHistoriesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentHistoriesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentHistoriesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DocumentHistoriesDelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "DocumentHistoriesList";
