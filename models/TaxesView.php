...
class TaxesView extends Taxes
{
    ...
    // CSS class/style
    public $CurrentPageName = "TaxesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "TaxesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TaxesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
