 ...
 * Page class
 */
class KategoriBeritasView extends KategoriBeritas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KategoriBeritasView";
    ...
    // CSS class/style
    public $CurrentPageName = "KategoriBeritasView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "KategoriBeritasList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "KategoriBeritasList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
