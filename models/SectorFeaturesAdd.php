 ...
 * Page class
 */
class SectorFeaturesAdd extends SectorFeatures
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SectorFeaturesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "SectorFeaturesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "SectorFeaturesView") {
