 ...
 * Page class
 */
class InvestorsEdit extends Investors
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InvestorsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "InvestorsEdit";
    ...
    public function setVisibility()
    {
        ...
        $this->investor_info->setVisibility();
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("InvestorsList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "InvestorsList") {
                ...
                if ($this->editRow()) {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "InvestorsList") {
                            ...
                            $returnUrl = "InvestorsList"; // Return list page content
                        }
                    }
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'investor_info' first before field var 'x_investor_info'
        $val = $CurrentForm->hasValue("investor_info") ? $CurrentForm->getValue("investor_info") : $CurrentForm->getValue("x_investor_info");
        if (!$this->investor_info->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->investor_info->Visible = false; // Disable update for API request
            } else {
                $this->investor_info->setFormValue($val);
            }
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->investor_info->CurrentValue = $this->investor_info->FormValue;
    ...
    public function renderRow()
    {
        ...
        // investor_info
        $this->investor_info->RowCssClass = "row";
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // investor_info
            $this->investor_info->ViewValue = $this->investor_info->CurrentValue;
            ...
            // investor_info
            $this->investor_info->setupEditAttributes();
            $this->investor_info->EditValue = HtmlEncode($this->investor_info->CurrentValue);
            $this->investor_info->PlaceHolder = RemoveHtml($this->investor_info->caption());
    ...
    protected function validateForm()
    {
        ...
        if ($this->investor_name->Visible && $this->investor_name->Required) {
        ...
        if ($this->investor_info->Visible && $this->investor_info->Required) {
            if (!$this->investor_info->IsDetailKey && EmptyValue($this->investor_info->FormValue)) {
                $this->investor_info->addErrorMessage(str_replace("%s", $this->investor_info->caption(), $this->investor_info->RequiredErrorMessage));
            }
        }
    ...
    protected function editRow()
    {
        ...
        // investor_name
        $this->investor_name->setDbValueDef($rsnew, $this->investor_name->CurrentValue, $this->investor_name->ReadOnly);

        // investor_info
        $this->investor_info->setDbValueDef($rsnew, $this->investor_info->CurrentValue, $this->investor_info->ReadOnly);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("InvestorsList"), "", $this->TableVar, true);
        $pageId = "edit";
