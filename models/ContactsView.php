...
class ContactsView extends Contacts
{
    ...
    // Page object name
    public $PageObjName = "ContactsView";
    ...
    // CSS class/style
    public $CurrentPageName = "ContactsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ContactsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ContactsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
