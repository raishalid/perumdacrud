 ...
 * Page class
 */
class ProjectStatusesView extends ProjectStatuses
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectStatusesView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectStatusesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ProjectStatusesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProjectStatusesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
