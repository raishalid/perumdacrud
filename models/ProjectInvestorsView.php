 ...
 * Page class
 */
class ProjectInvestorsView extends ProjectInvestors
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectInvestorsView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectInvestorsView";
    ...
    public function setVisibility()
    {
        ...
        $this->filecontract_name->setVisibility();
        $this->filecontract_path->setVisibility();
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ProjectInvestorsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProjectInvestorsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
