 ...
 * Page class
 */
class ItemsCategoriesView extends ItemsCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemsCategoriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "ItemsCategoriesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ItemsCategoriesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ItemsCategoriesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
