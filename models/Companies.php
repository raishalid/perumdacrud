...
/**
 * Table class for companies
 */
class Companies extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // info
        $this->info = new DbField(
            $this, // Table
            'x_info', // Variable name
            'info', // Name
            '`info`', // Expression
            '`info`', // Basic search expression
            201, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`info`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->info->InputTextType = "text";
        $this->info->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "companies";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("CompaniesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "CompaniesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "CompaniesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "CompaniesAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("CompaniesView", $parm);
        } else {
            $url = $this->keyUrl("CompaniesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CompaniesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CompaniesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CompaniesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CompaniesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("CompaniesDelete");
        }
    }
