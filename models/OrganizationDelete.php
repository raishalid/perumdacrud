 ...
 * Page class
 */
class OrganizationDelete extends Organization
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OrganizationDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "OrganizationDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("OrganizationList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("OrganizationList"); // Return to list
                return;
            }
        }
