 ...
 * Page class
 */
class ProjectCategoriesView extends ProjectCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectCategoriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectCategoriesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ProjectCategoriesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProjectCategoriesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
