...
class TransactionList extends Transaction
{
    ...
    // Page object name
    public $PageObjName = "TransactionList";
    ...
    public $FormName = "ftransactionlist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "TransactionList";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "TransactionAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "TransactionDelete";
        $this->MultiUpdateUrl = "TransactionUpdate";
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "ftransactiongrid";
        }
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->paid_at->AdvancedSearch->toJson(), ","); // Field paid_at
        ...
        $filterList = Concat($filterList, $this->acc_category_id->AdvancedSearch->toJson(), ","); // Field acc_category_id
        ...
        $filterList = Concat($filterList, $this->reconciled->AdvancedSearch->toJson(), ","); // Field reconciled
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "ftransactionsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field paid_at
        $this->paid_at->AdvancedSearch->SearchValue = @$filter["x_paid_at"];
        $this->paid_at->AdvancedSearch->SearchOperator = @$filter["z_paid_at"];
        $this->paid_at->AdvancedSearch->SearchCondition = @$filter["v_paid_at"];
        $this->paid_at->AdvancedSearch->SearchValue2 = @$filter["y_paid_at"];
        $this->paid_at->AdvancedSearch->SearchOperator2 = @$filter["w_paid_at"];
        $this->paid_at->AdvancedSearch->save();
        ...
        $this->acc_category_id->AdvancedSearch->SearchValue = @$filter["x_acc_category_id"];
        $this->acc_category_id->AdvancedSearch->SearchOperator = @$filter["z_acc_category_id"];
        $this->acc_category_id->AdvancedSearch->SearchCondition = @$filter["v_acc_category_id"];
        $this->acc_category_id->AdvancedSearch->SearchValue2 = @$filter["y_acc_category_id"];
        $this->acc_category_id->AdvancedSearch->SearchOperator2 = @$filter["w_acc_category_id"];
        $this->acc_category_id->AdvancedSearch->save();
        ...
        // Field reconciled
        $this->reconciled->AdvancedSearch->SearchValue = @$filter["x_reconciled"];
        $this->reconciled->AdvancedSearch->SearchOperator = @$filter["z_reconciled"];
        $this->reconciled->AdvancedSearch->SearchCondition = @$filter["v_reconciled"];
        $this->reconciled->AdvancedSearch->SearchValue2 = @$filter["y_reconciled"];
        $this->reconciled->AdvancedSearch->SearchOperator2 = @$filter["w_reconciled"];
        $this->reconciled->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->paid_at); // paid_at
            ...
            $this->updateSort($this->acc_category_id); // acc_category_id
            ...
            $this->updateSort($this->reconciled); // reconciled
        ...
        if ($this->CurrentMode == "view") {
            ...
            if (true) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"transaction\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if (true) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"transaction\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if (true) {
                if ($this->ModalAdd && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"transaction\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"ftransactionlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . " " . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"ftransactionlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . " " . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"transaction\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("acc_id", $this->createColumnOption("acc_id"));
            $option->add("paid_at", $this->createColumnOption("paid_at"));
            $option->add("departement_id", $this->createColumnOption("departement_id"));
            $option->add("type_id", $this->createColumnOption("type_id"));
            ...
            $option->add("acc_category_id", $this->createColumnOption("acc_category_id"));
            $option->add("payment_method", $this->createColumnOption("payment_method"));
            $option->add("reference", $this->createColumnOption("reference"));
            $option->add("parent_id", $this->createColumnOption("parent_id"));
            $option->add("reconciled", $this->createColumnOption("reconciled"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"ftransactionsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"ftransactionsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="ftransactionlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_transaction", "data-rowtype" => ROWTYPE_ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_transaction",
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"ftransactionsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
