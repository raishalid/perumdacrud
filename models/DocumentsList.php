...
class DocumentsList extends Documents
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->issued_at->AdvancedSearch->toJson(), ","); // Field issued_at
        $filterList = Concat($filterList, $this->due_at->AdvancedSearch->toJson(), ","); // Field due_at
        ...
        $filterList = Concat($filterList, $this->contact_tax_number->AdvancedSearch->toJson(), ","); // Field contact_tax_number
        ...
        $filterList = Concat($filterList, $this->contact_zip_code->AdvancedSearch->toJson(), ","); // Field contact_zip_code
        ...
        $filterList = Concat($filterList, $this->footer->AdvancedSearch->toJson(), ","); // Field footer
    ...
    protected function restoreFilterList()
    {
        ...
        // Field issued_at
        $this->issued_at->AdvancedSearch->SearchValue = @$filter["x_issued_at"];
        $this->issued_at->AdvancedSearch->SearchOperator = @$filter["z_issued_at"];
        $this->issued_at->AdvancedSearch->SearchCondition = @$filter["v_issued_at"];
        $this->issued_at->AdvancedSearch->SearchValue2 = @$filter["y_issued_at"];
        $this->issued_at->AdvancedSearch->SearchOperator2 = @$filter["w_issued_at"];
        $this->issued_at->AdvancedSearch->save();

        // Field due_at
        $this->due_at->AdvancedSearch->SearchValue = @$filter["x_due_at"];
        $this->due_at->AdvancedSearch->SearchOperator = @$filter["z_due_at"];
        $this->due_at->AdvancedSearch->SearchCondition = @$filter["v_due_at"];
        $this->due_at->AdvancedSearch->SearchValue2 = @$filter["y_due_at"];
        $this->due_at->AdvancedSearch->SearchOperator2 = @$filter["w_due_at"];
        $this->due_at->AdvancedSearch->save();
        ...
        // Field contact_tax_number
        $this->contact_tax_number->AdvancedSearch->SearchValue = @$filter["x_contact_tax_number"];
        $this->contact_tax_number->AdvancedSearch->SearchOperator = @$filter["z_contact_tax_number"];
        $this->contact_tax_number->AdvancedSearch->SearchCondition = @$filter["v_contact_tax_number"];
        $this->contact_tax_number->AdvancedSearch->SearchValue2 = @$filter["y_contact_tax_number"];
        $this->contact_tax_number->AdvancedSearch->SearchOperator2 = @$filter["w_contact_tax_number"];
        $this->contact_tax_number->AdvancedSearch->save();
        ...
        // Field contact_zip_code
        $this->contact_zip_code->AdvancedSearch->SearchValue = @$filter["x_contact_zip_code"];
        $this->contact_zip_code->AdvancedSearch->SearchOperator = @$filter["z_contact_zip_code"];
        $this->contact_zip_code->AdvancedSearch->SearchCondition = @$filter["v_contact_zip_code"];
        $this->contact_zip_code->AdvancedSearch->SearchValue2 = @$filter["y_contact_zip_code"];
        $this->contact_zip_code->AdvancedSearch->SearchOperator2 = @$filter["w_contact_zip_code"];
        $this->contact_zip_code->AdvancedSearch->save();
        ...
        // Field footer
        $this->footer->AdvancedSearch->SearchValue = @$filter["x_footer"];
        $this->footer->AdvancedSearch->SearchOperator = @$filter["z_footer"];
        $this->footer->AdvancedSearch->SearchCondition = @$filter["v_footer"];
        $this->footer->AdvancedSearch->SearchValue2 = @$filter["y_footer"];
        $this->footer->AdvancedSearch->SearchOperator2 = @$filter["w_footer"];
        $this->footer->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->currency_code;
        $searchFlds[] = &$this->contact_name;
        $searchFlds[] = &$this->contact_email;
        $searchFlds[] = &$this->contact_tax_number;
        $searchFlds[] = &$this->contact_phone;
        $searchFlds[] = &$this->contact_address;
        $searchFlds[] = &$this->contact_city;
        $searchFlds[] = &$this->contact_zip_code;
        $searchFlds[] = &$this->contact_state;
        $searchFlds[] = &$this->contact_country;
        $searchFlds[] = &$this->notes;
        $searchFlds[] = &$this->footer;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->issued_at); // issued_at
            $this->updateSort($this->due_at); // due_at
            $this->updateSort($this->amount); // amount
            $this->updateSort($this->currency_code); // currency_code
            $this->updateSort($this->currency_rate); // currency_rate
            ...
            $this->updateSort($this->contact_tax_number); // contact_tax_number
            $this->updateSort($this->contact_phone); // contact_phone
            $this->updateSort($this->contact_city); // contact_city
            $this->updateSort($this->contact_zip_code); // contact_zip_code
            $this->updateSort($this->contact_state); // contact_state
            $this->updateSort($this->contact_country); // contact_country
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("document_number", $this->createColumnOption("document_number"));
            $option->add("order_number", $this->createColumnOption("order_number"));
            $option->add("status", $this->createColumnOption("status"));
            $option->add("issued_at", $this->createColumnOption("issued_at"));
            $option->add("due_at", $this->createColumnOption("due_at"));
            $option->add("amount", $this->createColumnOption("amount"));
            $option->add("currency_code", $this->createColumnOption("currency_code"));
            $option->add("currency_rate", $this->createColumnOption("currency_rate"));
            ...
            $option->add("contact_tax_number", $this->createColumnOption("contact_tax_number"));
            $option->add("contact_phone", $this->createColumnOption("contact_phone"));
            $option->add("contact_city", $this->createColumnOption("contact_city"));
            $option->add("contact_zip_code", $this->createColumnOption("contact_zip_code"));
            $option->add("contact_state", $this->createColumnOption("contact_state"));
