 ...
 * Page class
 */
class SectorCategoriesAdd extends SectorCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SectorCategoriesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "SectorCategoriesAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("SectorCategoriesList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "SectorCategoriesList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "SectorCategoriesView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "SectorCategoriesList") {
                            ...
                            $returnUrl = "SectorCategoriesList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("SectorCategoriesList"), "", $this->TableVar, true);
