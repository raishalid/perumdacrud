...
class Organization extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->country_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("OrganizationList");
    }
    ...
    {
        global $Language;
        if ($pageName == "OrganizationView") {
            return $Language->phrase("View");
        } elseif ($pageName == "OrganizationEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "OrganizationAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("OrganizationView", $parm);
        } else {
            $url = $this->keyUrl("OrganizationView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("OrganizationEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("OrganizationList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("OrganizationAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("OrganizationList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("OrganizationDelete");
        }
    }
