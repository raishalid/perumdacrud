 ...
 * Page class
 */
class OrganizationAdd extends Organization
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OrganizationAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "OrganizationAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("OrganizationList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "OrganizationList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "OrganizationView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "OrganizationList") {
                            ...
                            $returnUrl = "OrganizationList"; // Return list page content
                        }
                    }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->country_id->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->country_id->setFormValue($val, true, $validate);
            }
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->country_id->EditValue = HtmlEncode($this->country_id->CurrentValue);
            $this->country_id->PlaceHolder = RemoveHtml($this->country_id->caption());
            if (strval($this->country_id->EditValue) != "" && is_numeric($this->country_id->EditValue)) {
                $this->country_id->EditValue = FormatNumber($this->country_id->EditValue, null);
            }
    ...
    protected function validateForm()
    {
        ...
        if (!CheckInteger($this->country_id->FormValue)) {
            $this->country_id->addErrorMessage($this->country_id->getErrorMessage(false));
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("OrganizationList"), "", $this->TableVar, true);
