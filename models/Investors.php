...
/**
 * Table class for investors
 */
class Investors extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->investor_name = new DbField(
            $this, // Table
            'x_investor_name', // Variable name
            'investor_name', // Name
            '`investor_name`', // Expression
            '`investor_name`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`investor_name`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->investor_name->Nullable = false; // NOT NULL field
        $this->investor_name->Required = true; // Required field
        $this->investor_name->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['investor_name'] = &$this->investor_name;

        // investor_info
        $this->investor_info = new DbField(
            $this, // Table
            'x_investor_info', // Variable name
            'investor_info', // Name
            '`investor_info`', // Expression
            '`investor_info`', // Basic search expression
            201, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`investor_info`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->investor_info->InputTextType = "text";
        $this->investor_info->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['investor_info'] = &$this->investor_info;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "investors";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->investor_info->DbValue = $row['investor_info'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("InvestorsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "InvestorsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "InvestorsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "InvestorsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_EDIT_ACTION"):
                return "InvestorsEdit";
            case Config("API_DELETE_ACTION"):
                return "InvestorsDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("InvestorsView", $parm);
        } else {
            $url = $this->keyUrl("InvestorsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("InvestorsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("InvestorsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("InvestorsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("InvestorsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("InvestorsDelete");
        }
    }
    ...
    public function renderListRow()
    {
        ...
        $this->investor_info->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        $this->investor_info->EditValue = $this->investor_info->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->investor_info);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->investor_info);
