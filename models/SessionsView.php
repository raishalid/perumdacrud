...
class SessionsView extends Sessions
{
    ...
    // Page object name
    public $PageObjName = "SessionsView";
    ...
    // CSS class/style
    public $CurrentPageName = "SessionsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "SessionsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "SessionsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
