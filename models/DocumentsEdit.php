...
class DocumentsEdit extends Documents
{
    ...
    protected function editRow()
    {
        ...
        // issued_at
        $this->issued_at->setDbValueDef($rsnew, UnFormatDateTime($this->issued_at->CurrentValue, $this->issued_at->formatPattern()), $this->issued_at->ReadOnly);

        // due_at
        $this->due_at->setDbValueDef($rsnew, UnFormatDateTime($this->due_at->CurrentValue, $this->due_at->formatPattern()), $this->due_at->ReadOnly);
        ...
        // contact_id
        $this->contact_id->setDbValueDef($rsnew, $this->contact_id->CurrentValue, $this->contact_id->ReadOnly);
        ...
        // contact_tax_number
        $this->contact_tax_number->setDbValueDef($rsnew, $this->contact_tax_number->CurrentValue, $this->contact_tax_number->ReadOnly);

        // contact_phone
        $this->contact_phone->setDbValueDef($rsnew, $this->contact_phone->CurrentValue, $this->contact_phone->ReadOnly);

        // contact_address
        $this->contact_address->setDbValueDef($rsnew, $this->contact_address->CurrentValue, $this->contact_address->ReadOnly);

        // contact_city
        $this->contact_city->setDbValueDef($rsnew, $this->contact_city->CurrentValue, $this->contact_city->ReadOnly);

        // contact_zip_code
        $this->contact_zip_code->setDbValueDef($rsnew, $this->contact_zip_code->CurrentValue, $this->contact_zip_code->ReadOnly);

        // contact_state
        $this->contact_state->setDbValueDef($rsnew, $this->contact_state->CurrentValue, $this->contact_state->ReadOnly);

        // contact_country
        $this->contact_country->setDbValueDef($rsnew, $this->contact_country->CurrentValue, $this->contact_country->ReadOnly);
