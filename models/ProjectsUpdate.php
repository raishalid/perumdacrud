 ...
 * Page class
 */
class ProjectsUpdate extends Projects
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectsUpdate";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectsUpdate";
    ...
    public function run()
    {
        ...
        if (count($this->RecKeys) <= 0) {
            $this->terminate("ProjectsList"); // No records selected, return to list
            return;
        }
        if ($this->isUpdate()) {
                if ($this->updateRows()) {
        ...
        if ($rs = $this->loadRecordset()) {
            ...
            while (!$rs->EOF) {
                if ($i == 1) {
                    ...
                    $this->project_provider_id->setDbValue($rs->fields['project_provider_id']);
                    $this->project_status_id->setDbValue($rs->fields['project_status_id']);
                    $this->funding_source_id->setDbValue($rs->fields['funding_source_id']);
                    $this->project_name->setDbValue($rs->fields['project_name']);
                    $this->project_description->setDbValue($rs->fields['project_description']);
                    $this->project_budget->setDbValue($rs->fields['project_budget']);
                    $this->project_target->setDbValue($rs->fields['project_target']);
                    $this->project_start->setDbValue($rs->fields['project_start']);
                    $this->project_duration->setDbValue($rs->fields['project_duration']);
                    $this->project_html->setDbValue($rs->fields['project_html']);
                    $this->project_headgbr->setDbValue($rs->fields['project_headgbr']);
                    $this->slug->setDbValue($rs->fields['slug']);
                    $this->created_at->setDbValue($rs->fields['created_at']);
                    $this->updated_at->setDbValue($rs->fields['updated_at']);
                } else {
                    if (!CompareValue($this->project_category_id->DbValue, $rs->fields['project_category_id'])) {
                        $this->project_category_id->CurrentValue = null;
                    }
                    if (!CompareValue($this->project_provider_id->DbValue, $rs->fields['project_provider_id'])) {
                        $this->project_provider_id->CurrentValue = null;
                    }
                    if (!CompareValue($this->project_status_id->DbValue, $rs->fields['project_status_id'])) {
                        $this->project_status_id->CurrentValue = null;
                    }
                    if (!CompareValue($this->funding_source_id->DbValue, $rs->fields['funding_source_id'])) {
                        $this->funding_source_id->CurrentValue = null;
                    }
                    if (!CompareValue($this->project_name->DbValue, $rs->fields['project_name'])) {
                        $this->project_name->CurrentValue = null;
                    }
                    if (!CompareValue($this->project_description->DbValue, $rs->fields['project_description'])) {
                        $this->project_description->CurrentValue = null;
                    }
                    if (!CompareValue($this->project_budget->DbValue, $rs->fields['project_budget'])) {
                        $this->project_budget->CurrentValue = null;
                    }
                    if (!CompareValue($this->project_target->DbValue, $rs->fields['project_target'])) {
                        $this->project_target->CurrentValue = null;
                    }
                    if (!CompareValue($this->project_start->DbValue, $rs->fields['project_start'])) {
                        $this->project_start->CurrentValue = null;
                    }
                    if (!CompareValue($this->project_duration->DbValue, $rs->fields['project_duration'])) {
                        $this->project_duration->CurrentValue = null;
                    }
                    if (!CompareValue($this->project_html->DbValue, $rs->fields['project_html'])) {
                        $this->project_html->CurrentValue = null;
                    }
                    if (!CompareValue($this->project_headgbr->DbValue, $rs->fields['project_headgbr'])) {
                        $this->project_headgbr->CurrentValue = null;
                    }
                    if (!CompareValue($this->slug->DbValue, $rs->fields['slug'])) {
                        $this->slug->CurrentValue = null;
                    }
                    if (!CompareValue($this->created_at->DbValue, $rs->fields['created_at'])) {
                        $this->created_at->CurrentValue = null;
                    }
                    if (!CompareValue($this->updated_at->DbValue, $rs->fields['updated_at'])) {
    ...
    protected function loadFormValues()
    {
        ...
        $this->project_category_id->MultiUpdate = $CurrentForm->getValue("u_project_category_id");
        ...
        $this->project_provider_id->MultiUpdate = $CurrentForm->getValue("u_project_provider_id");
        ...
        $this->project_status_id->MultiUpdate = $CurrentForm->getValue("u_project_status_id");
        ...
        $this->funding_source_id->MultiUpdate = $CurrentForm->getValue("u_funding_source_id");
        ...
        $this->project_description->MultiUpdate = $CurrentForm->getValue("u_project_description");
        ...
        $this->project_budget->MultiUpdate = $CurrentForm->getValue("u_project_budget");
        ...
        $this->project_target->MultiUpdate = $CurrentForm->getValue("u_project_target");
        ...
        $this->project_start->MultiUpdate = $CurrentForm->getValue("u_project_start");
        ...
        $this->project_duration->MultiUpdate = $CurrentForm->getValue("u_project_duration");
        ...
        $this->project_html->MultiUpdate = $CurrentForm->getValue("u_project_html");
        ...
        $this->project_headgbr->MultiUpdate = $CurrentForm->getValue("u_project_headgbr");
        ...
        $this->slug->MultiUpdate = $CurrentForm->getValue("u_slug");
        ...
        $this->updated_at->MultiUpdate = $CurrentForm->getValue("u_updated_at");
    ...
    protected function validateForm()
    {
        global $Language, $Security;
        $updateCnt = 0;
        if ($this->project_category_id->multiUpdateSelected()) {
            $updateCnt++;
        }
        if ($this->project_provider_id->multiUpdateSelected()) {
            $updateCnt++;
        }
        if ($this->project_status_id->multiUpdateSelected()) {
            $updateCnt++;
        }
        if ($this->funding_source_id->multiUpdateSelected()) {
            $updateCnt++;
        }
        if ($this->project_name->multiUpdateSelected()) {
            $updateCnt++;
        }
        if ($this->project_description->multiUpdateSelected()) {
            $updateCnt++;
        }
        if ($this->project_budget->multiUpdateSelected()) {
            $updateCnt++;
        }
        if ($this->project_target->multiUpdateSelected()) {
            $updateCnt++;
        }
        if ($this->project_start->multiUpdateSelected()) {
            $updateCnt++;
        }
        if ($this->project_duration->multiUpdateSelected()) {
            $updateCnt++;
        }
        if ($this->project_html->multiUpdateSelected()) {
            $updateCnt++;
        }
        if ($this->project_headgbr->multiUpdateSelected()) {
            $updateCnt++;
        }
        if ($this->slug->multiUpdateSelected()) {
            $updateCnt++;
        }
        if ($this->created_at->multiUpdateSelected()) {
            $updateCnt++;
        }
        if ($this->updated_at->multiUpdateSelected()) {
            $updateCnt++;
        }
        if ($updateCnt == 0) {
            return false;
        ...
        if ($this->project_category_id->Visible && $this->project_category_id->Required) {
            if ($this->project_category_id->MultiUpdate != "" && !$this->project_category_id->IsDetailKey && EmptyValue($this->project_category_id->FormValue)) {
        ...
        if ($this->project_provider_id->Visible && $this->project_provider_id->Required) {
            if ($this->project_provider_id->MultiUpdate != "" && !$this->project_provider_id->IsDetailKey && EmptyValue($this->project_provider_id->FormValue)) {
        ...
        if ($this->project_status_id->Visible && $this->project_status_id->Required) {
            if ($this->project_status_id->MultiUpdate != "" && !$this->project_status_id->IsDetailKey && EmptyValue($this->project_status_id->FormValue)) {
        ...
        if ($this->funding_source_id->Visible && $this->funding_source_id->Required) {
            if ($this->funding_source_id->MultiUpdate != "" && !$this->funding_source_id->IsDetailKey && EmptyValue($this->funding_source_id->FormValue)) {
        ...
        if ($this->funding_source_id->MultiUpdate != "") {
        ...
        if ($this->project_name->Visible && $this->project_name->Required) {
            if ($this->project_name->MultiUpdate != "" && !$this->project_name->IsDetailKey && EmptyValue($this->project_name->FormValue)) {
        ...
        if ($this->project_description->Visible && $this->project_description->Required) {
            if ($this->project_description->MultiUpdate != "" && !$this->project_description->IsDetailKey && EmptyValue($this->project_description->FormValue)) {
        ...
        if ($this->project_budget->Visible && $this->project_budget->Required) {
            if ($this->project_budget->MultiUpdate != "" && !$this->project_budget->IsDetailKey && EmptyValue($this->project_budget->FormValue)) {
                $this->project_budget->addErrorMessage(str_replace("%s", $this->project_budget->caption(), $this->project_budget->RequiredErrorMessage));
            }
        }
        if ($this->project_budget->MultiUpdate != "") {
        ...
        if ($this->project_target->Visible && $this->project_target->Required) {
            if ($this->project_target->MultiUpdate != "" && !$this->project_target->IsDetailKey && EmptyValue($this->project_target->FormValue)) {
        ...
        if ($this->project_start->Visible && $this->project_start->Required) {
            if ($this->project_start->MultiUpdate != "" && !$this->project_start->IsDetailKey && EmptyValue($this->project_start->FormValue)) {
                $this->project_start->addErrorMessage(str_replace("%s", $this->project_start->caption(), $this->project_start->RequiredErrorMessage));
            }
        }
        if ($this->project_start->MultiUpdate != "") {
        ...
        if ($this->project_duration->Visible && $this->project_duration->Required) {
            if ($this->project_duration->MultiUpdate != "" && !$this->project_duration->IsDetailKey && EmptyValue($this->project_duration->FormValue)) {
        ...
        if ($this->project_html->Visible && $this->project_html->Required) {
            if ($this->project_html->MultiUpdate != "" && !$this->project_html->IsDetailKey && EmptyValue($this->project_html->FormValue)) {
        ...
        if ($this->project_headgbr->Visible && $this->project_headgbr->Required) {
            if ($this->project_headgbr->MultiUpdate != "" && !$this->project_headgbr->IsDetailKey && EmptyValue($this->project_headgbr->FormValue)) {
        ...
        if ($this->slug->Visible && $this->slug->Required) {
            if ($this->slug->MultiUpdate != "" && !$this->slug->IsDetailKey && EmptyValue($this->slug->FormValue)) {
        ...
        if ($this->updated_at->Visible && $this->updated_at->Required) {
            if ($this->updated_at->MultiUpdate != "" && !$this->updated_at->IsDetailKey && EmptyValue($this->updated_at->FormValue)) {
                $this->updated_at->addErrorMessage(str_replace("%s", $this->updated_at->caption(), $this->updated_at->RequiredErrorMessage));
            }
        }
        if ($this->updated_at->MultiUpdate != "") {
    ...
    protected function editRow()
    {
        ...
        // project_category_id
        $this->project_category_id->setDbValueDef($rsnew, $this->project_category_id->CurrentValue, $this->project_category_id->ReadOnly || $this->project_category_id->MultiUpdate != "1");

        // project_provider_id
        $this->project_provider_id->setDbValueDef($rsnew, $this->project_provider_id->CurrentValue, $this->project_provider_id->ReadOnly || $this->project_provider_id->MultiUpdate != "1");

        // project_status_id
        $this->project_status_id->setDbValueDef($rsnew, $this->project_status_id->CurrentValue, $this->project_status_id->ReadOnly || $this->project_status_id->MultiUpdate != "1");

        // funding_source_id
        $this->funding_source_id->setDbValueDef($rsnew, $this->funding_source_id->CurrentValue, $this->funding_source_id->ReadOnly || $this->funding_source_id->MultiUpdate != "1");
        ...
        // project_description
        $this->project_description->setDbValueDef($rsnew, $this->project_description->CurrentValue, $this->project_description->ReadOnly || $this->project_description->MultiUpdate != "1");

        // project_budget
        $this->project_budget->setDbValueDef($rsnew, $this->project_budget->CurrentValue, $this->project_budget->ReadOnly || $this->project_budget->MultiUpdate != "1");

        // project_target
        $this->project_target->setDbValueDef($rsnew, $this->project_target->CurrentValue, $this->project_target->ReadOnly || $this->project_target->MultiUpdate != "1");

        // project_start
        $this->project_start->setDbValueDef($rsnew, UnFormatDateTime($this->project_start->CurrentValue, $this->project_start->formatPattern()), $this->project_start->ReadOnly || $this->project_start->MultiUpdate != "1");

        // project_duration
        $this->project_duration->setDbValueDef($rsnew, $this->project_duration->CurrentValue, $this->project_duration->ReadOnly || $this->project_duration->MultiUpdate != "1");

        // project_html
        $this->project_html->setDbValueDef($rsnew, $this->project_html->CurrentValue, $this->project_html->ReadOnly || $this->project_html->MultiUpdate != "1");

        // project_headgbr
        $this->project_headgbr->setDbValueDef($rsnew, $this->project_headgbr->CurrentValue, $this->project_headgbr->ReadOnly || $this->project_headgbr->MultiUpdate != "1");

        // created_at
        $this->created_at->setDbValueDef($rsnew, UnFormatDateTime($this->created_at->CurrentValue, $this->created_at->formatPattern()), $this->created_at->ReadOnly || $this->created_at->MultiUpdate != "1");

        // updated_at
        $this->updated_at->setDbValueDef($rsnew, UnFormatDateTime($this->updated_at->CurrentValue, $this->updated_at->formatPattern()), $this->updated_at->ReadOnly || $this->updated_at->MultiUpdate != "1");
