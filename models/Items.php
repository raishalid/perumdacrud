...
class Items extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // sale_price
        $this->sale_price = new DbField(
            $this, // Table
            'x_sale_price', // Variable name
            'sale_price', // Name
            '`sale_price`', // Expression
            '`sale_price`', // Basic search expression
            5, // Type
            15, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`sale_price`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->sale_price->InputTextType = "text";
        $this->sale_price->Nullable = false; // NOT NULL field
        $this->sale_price->Required = true; // Required field
        $this->sale_price->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->sale_price->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['sale_price'] = &$this->sale_price;

        // purchase_price
        $this->purchase_price = new DbField(
            $this, // Table
            'x_purchase_price', // Variable name
            'purchase_price', // Name
            '`purchase_price`', // Expression
            '`purchase_price`', // Basic search expression
            5, // Type
            15, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`purchase_price`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->purchase_price->InputTextType = "text";
        $this->purchase_price->Nullable = false; // NOT NULL field
        $this->purchase_price->Required = true; // Required field
        $this->purchase_price->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->purchase_price->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->enabled->Nullable = false; // NOT NULL field
        $this->enabled->Required = true; // Required field
        $this->enabled->DataType = DATATYPE_BOOLEAN;
        $this->enabled->Lookup = new Lookup('enabled', 'items', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
        $this->enabled->OptionCount = 2;
        $this->enabled->DefaultErrorMessage = $Language->phrase("IncorrectField");
        $this->enabled->SearchOperators = ["=", "<>"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "items";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->sale_price->DbValue = $row['sale_price'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ItemsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ItemsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ItemsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ItemsAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ItemsView", $parm);
        } else {
            $url = $this->keyUrl("ItemsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ItemsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ItemsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ItemsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ItemsDelete");
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->sale_price->EditValue = $this->sale_price->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->sale_price);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->sale_price);
