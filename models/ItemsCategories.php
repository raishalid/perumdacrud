...
/**
 * Table class for items_categories
 */
class ItemsCategories extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "items_categories";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->departement_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        $this->enabled->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->enabled->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "items_categories";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ItemsCategoriesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ItemsCategoriesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ItemsCategoriesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ItemsCategoriesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ItemsCategoriesView";
            case Config("API_ADD_ACTION"):
                return "ItemsCategoriesAdd";
            case Config("API_EDIT_ACTION"):
                return "ItemsCategoriesEdit";
            case Config("API_DELETE_ACTION"):
                return "ItemsCategoriesDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ItemsCategoriesView", $parm);
        } else {
            $url = $this->keyUrl("ItemsCategoriesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ItemsCategoriesAdd?" . $parm;
        } else {
            $url = "ItemsCategoriesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ItemsCategoriesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ItemsCategoriesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ItemsCategoriesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ItemsCategoriesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ItemsCategoriesDelete");
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->departement_id->Raw) {
            $this->departement_id->CurrentValue = HtmlDecode($this->departement_id->CurrentValue);
        }
        ...
        // enabled
        $this->enabled->setupEditAttributes();
        $this->enabled->EditValue = $this->enabled->CurrentValue;
        $this->enabled->PlaceHolder = RemoveHtml($this->enabled->caption());
        if (strval($this->enabled->EditValue) != "" && is_numeric($this->enabled->EditValue)) {
            $this->enabled->EditValue = FormatNumber($this->enabled->EditValue, null);
        }
