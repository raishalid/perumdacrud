 ...
 * Page class
 */
class DocumentItemTaxesView extends DocumentItemTaxes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentItemTaxesView";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentItemTaxesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "DocumentItemTaxesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DocumentItemTaxesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
