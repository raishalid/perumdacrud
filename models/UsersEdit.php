...
class UsersEdit extends Users
{
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->email_verified_at->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->email_verified_at->setFormValue($val, true, $validate);
            }
            $this->email_verified_at->CurrentValue = UnFormatDateTime($this->email_verified_at->CurrentValue, $this->email_verified_at->formatPattern());
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->email_verified_at->EditValue = HtmlEncode(FormatDateTime($this->email_verified_at->CurrentValue, $this->email_verified_at->formatPattern()));
    ...
    protected function validateForm()
    {
        ...
        if ($this->email_verified_at->Visible && $this->email_verified_at->Required) {
        ...
        if (!CheckDate($this->email_verified_at->FormValue, $this->email_verified_at->formatPattern())) {
        ...
        if ($this->remember_token->Visible && $this->remember_token->Required) {
    ...
    protected function editRow()
    {
        ...
        // email_verified_at
        $this->email_verified_at->setDbValueDef($rsnew, UnFormatDateTime($this->email_verified_at->CurrentValue, $this->email_verified_at->formatPattern()), $this->email_verified_at->ReadOnly);

        // password
        $this->_password->setDbValueDef($rsnew, $this->_password->CurrentValue, $this->_password->ReadOnly);

        // remember_token
        $this->remember_token->setDbValueDef($rsnew, $this->remember_token->CurrentValue, $this->remember_token->ReadOnly);
