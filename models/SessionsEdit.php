 ...
 * Page class
 */
class SessionsEdit extends Sessions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SessionsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "SessionsEdit";
    ...
    protected function editRow()
    {
        ...
        // last_activity
        $this->last_activity->setDbValueDef($rsnew, $this->last_activity->CurrentValue, $this->last_activity->ReadOnly);
