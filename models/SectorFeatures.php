...
/**
 * Table class for sector_features
 */
class SectorFeatures extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "sector_features";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "sector_features";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("SectorFeaturesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "SectorFeaturesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "SectorFeaturesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "SectorFeaturesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "SectorFeaturesView";
            case Config("API_ADD_ACTION"):
                return "SectorFeaturesAdd";
            case Config("API_EDIT_ACTION"):
                return "SectorFeaturesEdit";
            case Config("API_DELETE_ACTION"):
                return "SectorFeaturesDelete";
            case Config("API_LIST_ACTION"):
                return "SectorFeaturesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("SectorFeaturesView", $parm);
        } else {
            $url = $this->keyUrl("SectorFeaturesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "SectorFeaturesAdd?" . $parm;
        } else {
            $url = "SectorFeaturesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SectorFeaturesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SectorFeaturesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SectorFeaturesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SectorFeaturesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("SectorFeaturesDelete");
        }
    }
