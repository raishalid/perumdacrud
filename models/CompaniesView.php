...
class CompaniesView extends Companies
{
    ...
    // Page object name
    public $PageObjName = "CompaniesView";
    ...
    // CSS class/style
    public $CurrentPageName = "CompaniesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "CompaniesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "CompaniesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
