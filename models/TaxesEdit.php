...
class TaxesEdit extends Taxes
{
    ...
    // CSS class/style
    public $CurrentPageName = "TaxesEdit";
    ...
    protected function editRow()
    {
        ...
        // rate
        $this->rate->setDbValueDef($rsnew, $this->rate->CurrentValue, $this->rate->ReadOnly);
