...
/**
 * Table class for document_item_taxes
 */
class DocumentItemTaxes extends DbTable
{
    protected $SqlFrom = "";
    ...
    // Fields
    public $id;
    public $departement__d;
    public $company_id;
    public $type;
    public $document_id;
    public $document_item_id;
    public $tax_id;
    public $name;
    public $amount;
    public $created_from;
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "document_item_taxes";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // departement__d
        $this->departement__d = new DbField(
            $this, // Table
            'x_departement__d', // Variable name
            'departement__d', // Name
            '`departement__d`', // Expression
            '`departement__d`', // Basic search expression
            20, // Type
            20, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`departement__d`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->departement__d->InputTextType = "text";
        $this->departement__d->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->departement__d->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['departement__d'] = &$this->departement__d;
        ...
        // document_item_id
        $this->document_item_id = new DbField(
            $this, // Table
            'x_document_item_id', // Variable name
            'document_item_id', // Name
            '`document_item_id`', // Expression
            '`document_item_id`', // Basic search expression
            20, // Type
            20, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`document_item_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->document_item_id->InputTextType = "text";
        $this->document_item_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->document_item_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['document_item_id'] = &$this->document_item_id;

        // tax_id
        $this->tax_id = new DbField(
            $this, // Table
            'x_tax_id', // Variable name
            'tax_id', // Name
            '`tax_id`', // Expression
            '`tax_id`', // Basic search expression
            20, // Type
            20, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`tax_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->tax_id->InputTextType = "text";
        $this->tax_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->tax_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['tax_id'] = &$this->tax_id;
        ...
        $this->amount->addMethod("getDefault", fn() => 0.0000);
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "document_item_taxes";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->departement__d->DbValue = $row['departement__d'];
        $this->company_id->DbValue = $row['company_id'];
        $this->type->DbValue = $row['type'];
        $this->document_id->DbValue = $row['document_id'];
        $this->document_item_id->DbValue = $row['document_item_id'];
        $this->tax_id->DbValue = $row['tax_id'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DocumentItemTaxesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "DocumentItemTaxesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "DocumentItemTaxesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DocumentItemTaxesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DocumentItemTaxesView";
            case Config("API_ADD_ACTION"):
                return "DocumentItemTaxesAdd";
            case Config("API_EDIT_ACTION"):
                return "DocumentItemTaxesEdit";
            case Config("API_DELETE_ACTION"):
                return "DocumentItemTaxesDelete";
            case Config("API_LIST_ACTION"):
                return "DocumentItemTaxesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DocumentItemTaxesView", $parm);
        } else {
            $url = $this->keyUrl("DocumentItemTaxesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "DocumentItemTaxesAdd?" . $parm;
        } else {
            $url = "DocumentItemTaxesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentItemTaxesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentItemTaxesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentItemTaxesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentItemTaxesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DocumentItemTaxesDelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "DocumentItemTaxesList";
    ...
    public function renderEditRow()
    {
        ...
        $this->departement__d->EditValue = $this->departement__d->CurrentValue;
        ...
        $this->document_item_id->EditValue = $this->document_item_id->CurrentValue;
        ...
        $this->tax_id->EditValue = $this->tax_id->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->departement__d);
                    $doc->exportCaption($this->company_id);
                    $doc->exportCaption($this->type);
                    $doc->exportCaption($this->document_id);
                    $doc->exportCaption($this->document_item_id);
                    $doc->exportCaption($this->tax_id);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->departement__d);
                        $doc->exportField($this->company_id);
                        $doc->exportField($this->type);
                        $doc->exportField($this->document_id);
                        $doc->exportField($this->document_item_id);
                        $doc->exportField($this->tax_id);
