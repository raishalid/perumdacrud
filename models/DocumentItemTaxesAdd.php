 ...
 * Page class
 */
class DocumentItemTaxesAdd extends DocumentItemTaxes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentItemTaxesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentItemTaxesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "DocumentItemTaxesView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // departement__d
        $this->departement__d->setDbValueDef($rsnew, $this->departement__d->CurrentValue, false);
        ...
        // document_item_id
        $this->document_item_id->setDbValueDef($rsnew, $this->document_item_id->CurrentValue, false);

        // tax_id
        $this->tax_id->setDbValueDef($rsnew, $this->tax_id->CurrentValue, false);
