 ...
 * Page class
 */
class DocumentTotalsDelete extends DocumentTotals
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentTotalsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentTotalsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DocumentTotalsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("DocumentTotalsList"); // Return to list
                return;
            }
        }
