 ...
 * Page class
 */
class ModelHasPermissionsView extends ModelHasPermissions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ModelHasPermissionsView";
    ...
    // CSS class/style
    public $CurrentPageName = "ModelHasPermissionsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("permission_id") ?? Route("permission_id")) !== null) {
            ...
            $returnUrl = "ModelHasPermissionsList"; // Return to list
        }
        if (($keyValue = Get("model_type") ?? Route("model_type")) !== null) {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ModelHasPermissionsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
