 ...
 * Page class
 */
class DocumentHistoriesDelete extends DocumentHistories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentHistoriesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentHistoriesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DocumentHistoriesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("DocumentHistoriesList"); // Return to list
                return;
            }
        }
