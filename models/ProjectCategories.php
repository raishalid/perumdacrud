 ...
 */
class ProjectCategories extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "project_categories";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ProjectCategoriesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ProjectCategoriesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ProjectCategoriesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ProjectCategoriesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ProjectCategoriesView";
            case Config("API_ADD_ACTION"):
                return "ProjectCategoriesAdd";
            case Config("API_EDIT_ACTION"):
                return "ProjectCategoriesEdit";
            case Config("API_DELETE_ACTION"):
                return "ProjectCategoriesDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ProjectCategoriesView", $parm);
        } else {
            $url = $this->keyUrl("ProjectCategoriesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ProjectCategoriesAdd?" . $parm;
        } else {
            $url = "ProjectCategoriesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectCategoriesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectCategoriesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectCategoriesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectCategoriesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ProjectCategoriesDelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "ProjectCategoriesList";
