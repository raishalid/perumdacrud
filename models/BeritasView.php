 ...
 * Page class
 */
class BeritasView extends Beritas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BeritasView";
    ...
    // CSS class/style
    public $CurrentPageName = "BeritasView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "BeritasList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "BeritasList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
