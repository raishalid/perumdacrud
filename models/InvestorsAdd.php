 ...
 * Page class
 */
class InvestorsAdd extends Investors
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InvestorsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "InvestorsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "InvestorsView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // investor_name
        $this->investor_name->setDbValueDef($rsnew, $this->investor_name->CurrentValue, false);

        // investor_info
        $this->investor_info->setDbValueDef($rsnew, $this->investor_info->CurrentValue, false);
