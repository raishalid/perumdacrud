 ...
 * Page class
 */
class BeritasDelete extends Beritas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BeritasDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "BeritasDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("BeritasList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("BeritasList"); // Return to list
                return;
            }
        }
