 ...
 * Page class
 */
class ContactsAdd extends Contacts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContactsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ContactsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ContactsView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // tax_number
        $this->tax_number->setDbValueDef($rsnew, $this->tax_number->CurrentValue, false);
