 ...
 * Page class
 */
class ProjectFilesDelete extends ProjectFiles
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectFilesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectFilesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProjectFilesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ProjectFilesList"); // Return to list
                return;
            }
        }
