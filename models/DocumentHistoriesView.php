 ...
 * Page class
 */
class DocumentHistoriesView extends DocumentHistories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentHistoriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentHistoriesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "DocumentHistoriesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DocumentHistoriesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
