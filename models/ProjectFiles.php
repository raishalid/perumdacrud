...
/**
 * Table class for project_files
 */
class ProjectFiles extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "project_files";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->project_id->Lookup = new Lookup('project_id', 'projects', false, 'id', ["project_name","","",""], '', '', [], [], [], [], [], [], '', '', "`project_name`");
        $this->project_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->project_id->SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        // file_info
        $this->file_info = new DbField(
            $this, // Table
            'x_file_info', // Variable name
            'file_info', // Name
            '`file_info`', // Expression
            '`file_info`', // Basic search expression
            201, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`file_info`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->file_info->InputTextType = "text";
        $this->file_info->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['file_info'] = &$this->file_info;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "project_files";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->file_info->DbValue = $row['file_info'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ProjectFilesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ProjectFilesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ProjectFilesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ProjectFilesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_EDIT_ACTION"):
                return "ProjectFilesEdit";
            case Config("API_DELETE_ACTION"):
                return "ProjectFilesDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ProjectFilesView", $parm);
        } else {
            $url = $this->keyUrl("ProjectFilesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectFilesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectFilesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectFilesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectFilesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ProjectFilesDelete");
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->file_info->EditValue = $this->file_info->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->file_info);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->file_info);
    ...
    public function getFileData($fldparm, $key, $resize, $width = 0, $height = 0, $plugins = [])
    {
        ...
        $fileNameFld = "";
        $fileTypeFld = "";
        if ($fldparm == 'file_path') {
            $fldName = "file_path";
            $fileNameFld = "file_path";
        } else {
