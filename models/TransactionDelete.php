 ...
 * Page class
 */
class TransactionDelete extends Transaction
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransactionDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TransactionDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TransactionList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TransactionList"); // Return to list
                return;
            }
        }
