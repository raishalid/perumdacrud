 ...
 * Page class
 */
class DocumentItemsDelete extends DocumentItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentItemsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentItemsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DocumentItemsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("DocumentItemsList"); // Return to list
                return;
            }
        }
