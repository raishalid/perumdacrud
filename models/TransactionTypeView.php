 ...
 * Page class
 */
class TransactionTypeView extends TransactionType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransactionTypeView";
    ...
    // CSS class/style
    public $CurrentPageName = "TransactionTypeView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "TransactionTypeList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TransactionTypeList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
