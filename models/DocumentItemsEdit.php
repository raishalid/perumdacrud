 ...
 * Page class
 */
class DocumentItemsEdit extends DocumentItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentItemsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentItemsEdit";
    ...
    protected function editRow()
    {
        ...
        // departemen_id
        $this->departemen_id->setDbValueDef($rsnew, $this->departemen_id->CurrentValue, $this->departemen_id->ReadOnly);
        ...
        // sku
        $this->sku->setDbValueDef($rsnew, $this->sku->CurrentValue, $this->sku->ReadOnly);
        ...
        // tax
        $this->tax->setDbValueDef($rsnew, $this->tax->CurrentValue, $this->tax->ReadOnly);

        // discount_type
        $this->discount_type->setDbValueDef($rsnew, $this->discount_type->CurrentValue, $this->discount_type->ReadOnly);

        // discount_rate
        $this->discount_rate->setDbValueDef($rsnew, $this->discount_rate->CurrentValue, $this->discount_rate->ReadOnly);
