 ...
 * Page class
 */
class TaxesDelete extends Taxes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TaxesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TaxesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TaxesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TaxesList"); // Return to list
                return;
            }
        }
