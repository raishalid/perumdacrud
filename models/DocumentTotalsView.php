 ...
 * Page class
 */
class DocumentTotalsView extends DocumentTotals
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentTotalsView";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentTotalsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "DocumentTotalsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DocumentTotalsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
