...
/**
 * Table class for document_items
 */
class DocumentItems extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "document_items";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // departemen_id
        $this->departemen_id = new DbField(
            $this, // Table
            'x_departemen_id', // Variable name
            'departemen_id', // Name
            '`departemen_id`', // Expression
            '`departemen_id`', // Basic search expression
            20, // Type
            20, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`departemen_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->departemen_id->InputTextType = "text";
        $this->departemen_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->departemen_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->item_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        // sku
        $this->sku = new DbField(
            $this, // Table
            'x_sku', // Variable name
            'sku', // Name
            '`sku`', // Expression
            '`sku`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`sku`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->sku->InputTextType = "text";
        $this->sku->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['sku'] = &$this->sku;
        ...
        // tax
        $this->tax = new DbField(
            $this, // Table
            'x_tax', // Variable name
            'tax', // Name
            '`tax`', // Expression
            '`tax`', // Basic search expression
            4, // Type
            15, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`tax`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->tax->addMethod("getDefault", fn() => 0.0000);
        $this->tax->InputTextType = "text";
        $this->tax->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->tax->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['tax'] = &$this->tax;

        // discount_type
        $this->discount_type = new DbField(
            $this, // Table
            'x_discount_type', // Variable name
            'discount_type', // Name
            '`discount_type`', // Expression
            '`discount_type`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`discount_type`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->discount_type->addMethod("getDefault", fn() => "normal");
        $this->discount_type->InputTextType = "text";
        $this->discount_type->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['discount_type'] = &$this->discount_type;

        // discount_rate
        $this->discount_rate = new DbField(
            $this, // Table
            'x_discount_rate', // Variable name
            'discount_rate', // Name
            '`discount_rate`', // Expression
            '`discount_rate`', // Basic search expression
            5, // Type
            15, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`discount_rate`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->discount_rate->addMethod("getDefault", fn() => 0.0000);
        $this->discount_rate->InputTextType = "text";
        $this->discount_rate->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->discount_rate->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['discount_rate'] = &$this->discount_rate;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "document_items";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DocumentItemsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "DocumentItemsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "DocumentItemsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DocumentItemsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "DocumentItemsAdd";
            case Config("API_EDIT_ACTION"):
                return "DocumentItemsEdit";
            case Config("API_DELETE_ACTION"):
                return "DocumentItemsDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DocumentItemsView", $parm);
        } else {
            $url = $this->keyUrl("DocumentItemsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "DocumentItemsAdd?" . $parm;
        } else {
            $url = "DocumentItemsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentItemsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentItemsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentItemsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentItemsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DocumentItemsDelete");
        }
    }
    ...
    public function renderListRow()
    {
        ...
        $this->discount_rate->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        $this->sku->EditValue = $this->sku->CurrentValue;
        ...
        $this->discount_type->EditValue = $this->discount_type->CurrentValue;
        $this->discount_type->PlaceHolder = RemoveHtml($this->discount_type->caption());

        // discount_rate
        $this->discount_rate->setupEditAttributes();
        $this->discount_rate->EditValue = $this->discount_rate->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->departemen_id);
                    $doc->exportCaption($this->company_id);
                    $doc->exportCaption($this->item_id);
                    $doc->exportCaption($this->name);
                    $doc->exportCaption($this->description);
                    $doc->exportCaption($this->sku);
                    $doc->exportCaption($this->quantity);
                    $doc->exportCaption($this->price);
                    $doc->exportCaption($this->tax);
                    $doc->exportCaption($this->discount_type);
                    $doc->exportCaption($this->discount_rate);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->departemen_id);
                        $doc->exportField($this->company_id);
                        $doc->exportField($this->item_id);
                        $doc->exportField($this->name);
                        $doc->exportField($this->description);
                        $doc->exportField($this->sku);
                        $doc->exportField($this->quantity);
                        $doc->exportField($this->price);
                        $doc->exportField($this->tax);
                        $doc->exportField($this->discount_type);
                        $doc->exportField($this->discount_rate);
