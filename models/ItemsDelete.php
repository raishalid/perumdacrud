 ...
 * Page class
 */
class ItemsDelete extends Items
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ItemsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ItemsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ItemsList"); // Return to list
                return;
            }
        }
