...
/**
 * Table class for document_totals
 */
class DocumentTotals extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "document_totals";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->sort_order = new DbField(
            $this, // Table
            'x_sort_order', // Variable name
            'sort_order', // Name
            '`sort_order`', // Expression
            '`sort_order`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`sort_order`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->sort_order->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "document_totals";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DocumentTotalsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "DocumentTotalsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "DocumentTotalsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DocumentTotalsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DocumentTotalsView";
            case Config("API_ADD_ACTION"):
                return "DocumentTotalsAdd";
            case Config("API_EDIT_ACTION"):
                return "DocumentTotalsEdit";
            case Config("API_DELETE_ACTION"):
                return "DocumentTotalsDelete";
            case Config("API_LIST_ACTION"):
                return "DocumentTotalsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DocumentTotalsView", $parm);
        } else {
            $url = $this->keyUrl("DocumentTotalsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "DocumentTotalsAdd?" . $parm;
        } else {
            $url = "DocumentTotalsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentTotalsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentTotalsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentTotalsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentTotalsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DocumentTotalsDelete");
        }
    }
