 ...
 * Page class
 */
class DocumentHistoriesAdd extends DocumentHistories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentHistoriesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentHistoriesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "DocumentHistoriesView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        $this->notify->setDbValueDef($rsnew, $tmpBool, false);
