 ...
 * Page class
 */
class SectorFeaturesDelete extends SectorFeatures
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SectorFeaturesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "SectorFeaturesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SectorFeaturesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("SectorFeaturesList"); // Return to list
                return;
            }
        }
