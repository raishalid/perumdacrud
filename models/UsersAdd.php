...
class UsersAdd extends Users
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        // email_verified_at
        $this->email_verified_at->setDbValueDef($rsnew, UnFormatDateTime($this->email_verified_at->CurrentValue, $this->email_verified_at->formatPattern()), false);

        // password
        $this->_password->setDbValueDef($rsnew, $this->_password->CurrentValue, false);

        // remember_token
        $this->remember_token->setDbValueDef($rsnew, $this->remember_token->CurrentValue, false);
