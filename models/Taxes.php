...
/**
 * Table class for taxes
 */
class Taxes extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->enabled->Lookup = new Lookup('enabled', 'taxes', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "taxes";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TaxesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TaxesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TaxesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TaxesAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TaxesView", $parm);
        } else {
            $url = $this->keyUrl("TaxesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TaxesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TaxesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TaxesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TaxesDelete");
        }
    }
