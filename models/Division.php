...
class Division extends DbTable
{
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DivisionList");
    }
    ...
    {
        global $Language;
        if ($pageName == "DivisionView") {
            return $Language->phrase("View");
        } elseif ($pageName == "DivisionEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DivisionAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DivisionView", $parm);
        } else {
            $url = $this->keyUrl("DivisionView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DivisionEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DivisionList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DivisionAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DivisionList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DivisionDelete");
        }
    }
