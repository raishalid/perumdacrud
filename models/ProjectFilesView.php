 ...
 * Page class
 */
class ProjectFilesView extends ProjectFiles
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectFilesView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectFilesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ProjectFilesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProjectFilesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
