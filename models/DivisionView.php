 ...
 * Page class
 */
class DivisionView extends Division
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DivisionView";
    ...
    // CSS class/style
    public $CurrentPageName = "DivisionView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "DivisionList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DivisionList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
