...
/**
 * Table class for sector_categories
 */
class SectorCategories extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "sector_categories";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "sector_categories";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("SectorCategoriesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "SectorCategoriesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "SectorCategoriesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "SectorCategoriesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "SectorCategoriesView";
            case Config("API_ADD_ACTION"):
                return "SectorCategoriesAdd";
            case Config("API_EDIT_ACTION"):
                return "SectorCategoriesEdit";
            case Config("API_DELETE_ACTION"):
                return "SectorCategoriesDelete";
            case Config("API_LIST_ACTION"):
                return "SectorCategoriesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("SectorCategoriesView", $parm);
        } else {
            $url = $this->keyUrl("SectorCategoriesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "SectorCategoriesAdd?" . $parm;
        } else {
            $url = "SectorCategoriesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SectorCategoriesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SectorCategoriesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SectorCategoriesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SectorCategoriesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("SectorCategoriesDelete");
        }
    }
