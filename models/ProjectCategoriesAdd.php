 ...
 * Page class
 */
class ProjectCategoriesAdd extends ProjectCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectCategoriesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectCategoriesAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("ProjectCategoriesList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "ProjectCategoriesList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "ProjectCategoriesView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ProjectCategoriesList") {
                            ...
                            $returnUrl = "ProjectCategoriesList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ProjectCategoriesList"), "", $this->TableVar, true);
