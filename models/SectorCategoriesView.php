 ...
 * Page class
 */
class SectorCategoriesView extends SectorCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SectorCategoriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "SectorCategoriesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "SectorCategoriesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "SectorCategoriesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
