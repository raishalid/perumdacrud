 ...
 * Page class
 */
class InvestorsView extends Investors
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InvestorsView";
    ...
    // CSS class/style
    public $CurrentPageName = "InvestorsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "InvestorsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "InvestorsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
