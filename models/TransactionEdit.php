 ...
 * Page class
 */
class TransactionEdit extends Transaction
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransactionEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "TransactionEdit";
    ...
    protected function editRow()
    {
        ...
        // acc_id
        $this->acc_id->setDbValueDef($rsnew, $this->acc_id->CurrentValue, $this->acc_id->ReadOnly);

        // paid_at
        $this->paid_at->setDbValueDef($rsnew, UnFormatDateTime($this->paid_at->CurrentValue, $this->paid_at->formatPattern()), $this->paid_at->ReadOnly);
        ...
        // acc_category_id
        $this->acc_category_id->setDbValueDef($rsnew, $this->acc_category_id->CurrentValue, $this->acc_category_id->ReadOnly);
        ...
        $this->reconciled->setDbValueDef($rsnew, $tmpBool, $this->reconciled->ReadOnly);
