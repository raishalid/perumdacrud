 ...
 * Page class
 */
class SectorFeaturesEdit extends SectorFeatures
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SectorFeaturesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "SectorFeaturesEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("SectorFeaturesList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "SectorFeaturesList") {
                ...
                if ($this->editRow()) {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "SectorFeaturesList") {
                            ...
                            $returnUrl = "SectorFeaturesList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("SectorFeaturesList"), "", $this->TableVar, true);
        $pageId = "edit";
