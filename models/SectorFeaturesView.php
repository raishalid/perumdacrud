 ...
 * Page class
 */
class SectorFeaturesView extends SectorFeatures
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SectorFeaturesView";
    ...
    // CSS class/style
    public $CurrentPageName = "SectorFeaturesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "SectorFeaturesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "SectorFeaturesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
