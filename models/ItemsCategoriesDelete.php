 ...
 * Page class
 */
class ItemsCategoriesDelete extends ItemsCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemsCategoriesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ItemsCategoriesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ItemsCategoriesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ItemsCategoriesList"); // Return to list
                return;
            }
        }
