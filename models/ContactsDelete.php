 ...
 * Page class
 */
class ContactsDelete extends Contacts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContactsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ContactsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ContactsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ContactsList"); // Return to list
                return;
            }
        }
