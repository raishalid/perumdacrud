 ...
 * Page class
 */
class DocumentItemsView extends DocumentItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentItemsView";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentItemsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "DocumentItemsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DocumentItemsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
