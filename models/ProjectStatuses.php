...
/**
 * Table class for project_statuses
 */
class ProjectStatuses extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "project_statuses";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // status_description
        $this->status_description = new DbField(
            $this, // Table
            'x_status_description', // Variable name
            'status_description', // Name
            '`status_description`', // Expression
            '`status_description`', // Basic search expression
            201, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`status_description`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->status_description->InputTextType = "text";
        $this->status_description->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['status_description'] = &$this->status_description;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "project_statuses";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->status_description->DbValue = $row['status_description'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ProjectStatusesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ProjectStatusesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ProjectStatusesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ProjectStatusesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "ProjectStatusesAdd";
            case Config("API_EDIT_ACTION"):
                return "ProjectStatusesEdit";
            case Config("API_DELETE_ACTION"):
                return "ProjectStatusesDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ProjectStatusesView", $parm);
        } else {
            $url = $this->keyUrl("ProjectStatusesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ProjectStatusesAdd?" . $parm;
        } else {
            $url = "ProjectStatusesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectStatusesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectStatusesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectStatusesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProjectStatusesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ProjectStatusesDelete");
        }
    }
    ...
    public function renderListRow()
    {
        ...
        $this->status_description->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        $this->status_description->EditValue = $this->status_description->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->status_description);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->status_description);
