 ...
 * Page class
 */
class DocumentTotalsEdit extends DocumentTotals
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentTotalsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentTotalsEdit";
    ...
    protected function editRow()
    {
        ...
        // sort_order
        $this->sort_order->setDbValueDef($rsnew, $this->sort_order->CurrentValue, $this->sort_order->ReadOnly);
