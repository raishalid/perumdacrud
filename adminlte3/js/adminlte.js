...
(function (global, factory) {
    ...
    CardRefresh._jQueryInterface = function _jQueryInterface(config) {
      return this.each(function () {
        ...
        if (typeof config === 'string') {
          ...
          data[config](); // } else if (typeof config === 'undefined') { //***
          //   data._init()
        }
      });
    };
  ...
  $__default["default"](SELECTOR_NAVBAR + " " + SELECTOR_DROPDOWN_TOGGLE).on('click', function (event) {
    event.preventDefault(); //*** if ($(event.target).parent().hasClass(CLASS_NAME_DROPDOWN_SUBMENU)) {
    //   return
    // }
    // setTimeout(function () {
  ...
  var Layout = /*#__PURE__*/function () {
    ...
    _proto.fixLayoutHeight = function fixLayoutHeight(extra) {
      ...
      if (typeof window.OverlayScrollbars !== 'undefined') {
        //***
        OverlayScrollbars(document.querySelector(SELECTOR_SIDEBAR$1), {
          scrollbars: {
            theme: this._config.scrollbarTheme,
            autoHide: this._config.scrollbarAutoHide,
            clickScroll: true
